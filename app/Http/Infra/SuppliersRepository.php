...
class SuppliersRepository
{
	...
	public function fetchAllNearbySuppliers($customerId)
	{
		...
		return DB::table('customers_addresses')->select(
			...
			DB::raw('addresses.street as customer_street'),
			DB::raw('addresses.number as customer_number'),
			DB::raw('addresses.postal_code as customer_postal_code'),
			DB::raw('addresses.neighborhood as customer_neighborhood'),
			DB::raw('addresses.city as customer_city'),
			DB::raw('addresses.state as customer_state'),
			DB::raw('addresses.country as customer_country'),
			DB::raw('addresses.lat as customer_lat'),
			DB::raw('addresses.long as customer_long'),
